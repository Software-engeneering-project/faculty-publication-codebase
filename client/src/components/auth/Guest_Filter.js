...
import Display_guest  from './display_guest';
import Papers from "./temp_data";
import "./../css/home.css"
import Guest_navbar from './guest_navbar'
...
function handlereset() {
  ...
  return (
    <>
      ...
      {myRows.length > 0 && <Display_guest citation = {citation} patent = {patent} privat = {privat} myRows={myRows} />}
